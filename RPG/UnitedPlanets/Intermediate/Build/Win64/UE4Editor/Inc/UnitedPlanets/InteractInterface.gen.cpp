...
#include "UnitedPlanets/Public/Interact/InteractInterface.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	...
	UNITEDPLANETS_API UClass* Z_Construct_UClass_UInteractInterface();
	COREUOBJECT_API UClass* Z_Construct_UClass_UInterface();
	UPackage* Z_Construct_UPackage__Script_UnitedPlanets();
	UNITEDPLANETS_API UFunction* Z_Construct_UFunction_UInteractInterface_EndFocus();
	UNITEDPLANETS_API UFunction* Z_Construct_UFunction_UInteractInterface_OnInteract();
	ENGINE_API UClass* Z_Construct_UClass_AActor_NoRegister();
	UNITEDPLANETS_API UFunction* Z_Construct_UFunction_UInteractInterface_StartFocus();
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UInteractInterface_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UInteractInterface_OnInteract, "OnInteract" }, // 1679896391
	...
	IMPLEMENT_CLASS(UInteractInterface, 2592405319);
	template<> UNITEDPLANETS_API UClass* StaticClass<UInteractInterface>()
	{
		return UInteractInterface::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UInteractInterface(Z_Construct_UClass_UInteractInterface, &UInteractInterface::StaticClass, TEXT("/Script/UnitedPlanets"), TEXT("UInteractInterface"), false, nullptr, nullptr, nullptr);
