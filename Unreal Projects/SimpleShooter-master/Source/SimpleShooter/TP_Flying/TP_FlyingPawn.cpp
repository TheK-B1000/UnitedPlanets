...
ATP_FlyingPawn::ATP_FlyingPawn()
{
	...
	{
		ConstructorHelpers::FObjectFinderOptional<UStaticMesh> StarshipMesh;
		FConstructorStatics()
			: StarshipMesh(TEXT("/Game/Flying/Meshes/UFO.UFO"))
		{
		}
	};
	...
	StarshipMesh = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("StarshipMesh0"));
	StarshipMesh->SetStaticMesh(ConstructorStatics.StarshipMesh.Get());	// Set static mesh
	RootComponent = StarshipMesh; // StarshipMesh is now RootComponent
