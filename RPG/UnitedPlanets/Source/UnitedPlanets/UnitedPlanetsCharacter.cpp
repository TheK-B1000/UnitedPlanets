	...
	if (ProjectileClass != NULL)
	{
		...
		if (World != NULL)
		{
			if (bUsingMotionControllers)
			{
				...
				World->SpawnActor<AUnitedPlanetsProjectile>(ProjectileClass, SpawnLocation, SpawnRotation);
			}
			else
			{
				...
				World->SpawnActor<AUnitedPlanetsProjectile>(ProjectileClass, SpawnLocation, SpawnRotation, ActorSpawnParams);
			}
		}
	}
...
void AUnitedPlanetsCharacter::OnResetVR()
{
...
bool AUnitedPlanetsCharacter::EnableTouchscreenMovement(class UInputComponent* PlayerInputComponent)
{
